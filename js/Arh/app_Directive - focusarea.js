...
aplc.controller('dateController', ['$http', function($http){
 ...
 aplc.controller('elmKeyCtrl' ,function(focusarea) { 
     //var fcsare=focusarea
    ...
    this.apasElm=function(idx ,ek){
        ...
        if (obMfiltre[ek]!=undefined){ 
            ...
            }else aista.arata[ek]=!aista.arata[ek]
...
/* aplc.controller('focusCtrl',function(focusarea){
   
    this.numeInput=['focusUnu', 'focusDoi']
    this.apasareButon=function(idx){
        focusarea(this.numeInput[idx]);
    }
})*/
})();
